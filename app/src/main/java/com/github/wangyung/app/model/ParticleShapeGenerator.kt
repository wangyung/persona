...
internal fun createSakuraParticle(strokeRange: IntRange): ParticleShape = ParticleShape.Path(
...
internal fun createStarParticle(color: Color, radiusRange: IntRange): ParticleShape.Circle = ParticleShape.Circle(
    color = color,
